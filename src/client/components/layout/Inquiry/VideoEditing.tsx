...
interface VideoEditingFormInputs {
  Name: string;
  Email: string;
  Platforms: string[];
  ContentType: string[];
...
const VideoEditingForm: React.FC = () => {
  ...
  } = useForm<VideoEditingFormInputs>();
    ...
    <div className="w-full max-w-2xl mx-auto bg-white rounded-2xl shadow-md p-8">
      ...
      <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2">
            {["Shorts", "Reels", "Stories", "Long Form", "Ads"].map((type) => (
          ...
          {/* Conditionally show Other text field */}
          {showOtherInput && (
            <div className="mt-2">
              <input
                type="text"
        ...
        <div>
          ...
          >
            ...
            <option value="<1 min">Less than 1 min</option>
            <option value="1-3 min">1–3 mins</option>
            <option value="3-5 min">3–5 mins</option>
